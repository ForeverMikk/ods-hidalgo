    ...
    return (
        ...
        <div className='main-container-w'>
          ...
          <div className='form-container-g'>
            ...
            <label className='text-start' for='campo1'>Escibe una palabra que represente tu Hidalgo ideal:</label>
            <input className='my-form' type="text" placeholder='Escribe tu idea' name='campo1' />
            <label className='text-start' for='campo2'>Sube una imagen que represente a Hidalgo:</label>
            <input className='my-form' type="file" placeholder='Sube una foto' name='campo2' />
            </div>
